...
namespace SuperSocket.Connection
{
    ...
    public static class Extensions
    {
        ...
        /// <returns>A UniTask that represents the asynchronous receive operation. The result contains the next package, or <c>null</c> if the stream is completed.</returns>
        public static async UniTask<TPackageInfo> ReceiveAsync<TPackageInfo>(this IAsyncEnumerator<TPackageInfo> packageStream)
        {
