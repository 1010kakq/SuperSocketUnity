...
namespace SuperSocket.Connection
{
    ...
    public abstract class ConnectionBase : IConnection
    {
        ...
        public abstract UniTask SendAsync(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        public abstract UniTask SendAsync(ReadOnlySequence<byte> buffer, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        public abstract UniTask SendAsync<TPackage>(IPackageEncoder<TPackage> packageEncoder, TPackage package, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        public abstract UniTask SendAsync(Action<PipeWriter> write, CancellationToken cancellationToken = default);
        ...
        public abstract UniTask CloseAsync(CloseReason closeReason);

        /// <summary>
        /// Detaches the connection asynchronously.
        /// </summary>
        /// <returns>A UniTask that represents the asynchronous detach operation.</returns>
        public abstract UniTask DetachAsync();

        public void Dispose()
        {
            CloseAsync(Connection.CloseReason.LocalClosing).Forget();
        }

        public ValueTask DisposeAsync()
        {
            return CloseAsync(Connection.CloseReason.LocalClosing).AsValueTask();
        }
    }
}
