...
namespace SuperSocket.Connection
{
    ...
    public abstract class VirtualConnection : PipeConnection, IVirtualConnection
    {
        ...
        /// <inheritdoc/>
        public async UniTask<FlushResult> WriteInputPipeDataAsync(ReadOnlyMemory<byte> memory, CancellationToken cancellationToken)
        {
            return await Input.Writer.WriteAsync(memory, cancellationToken);
        }
    }
}
