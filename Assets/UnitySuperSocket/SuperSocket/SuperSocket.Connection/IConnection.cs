...
namespace SuperSocket.Connection
{
    ...
    public interface IConnection : IDisposable, IAsyncDisposable
    {
        ...
        UniTask SendAsync(ReadOnlyMemory<byte> data, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync(ReadOnlySequence<byte> data, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync<TPackage>(IPackageEncoder<TPackage> packageEncoder, TPackage package, CancellationToken cancellationToken = default);
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync(Action<PipeWriter> write, CancellationToken cancellationToken = default);
        ...
        UniTask CloseAsync(CloseReason closeReason);
