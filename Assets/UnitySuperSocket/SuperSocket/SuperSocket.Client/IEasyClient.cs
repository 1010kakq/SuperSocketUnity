...
namespace SuperSocket.Client
{
    ...
    public interface IEasyClient : IDisposable, IAsyncDisposable
    {
        ...
        UniTask<bool> ConnectAsync(EndPoint remoteEndPoint, CancellationToken cancellationToken = default);
        ...
        /// <param name="data">The data to send.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync(ReadOnlySequence<byte> data);
        ...
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync<TSendPackage>(IPackageEncoder<TSendPackage> packageEncoder, TSendPackage package);
        ...
        where TReceivePackage : class
    {
        ...
        UniTask<TReceivePackage> ReceiveAsync();
        ...
        where TReceivePackage : class
    {
        ...
        /// <param name="package">The package to send.</param>
        /// <returns>A UniTask that represents the asynchronous send operation.</returns>
        UniTask SendAsync(TSendPackage package);
    }
}
